...
--
-- Name: meeting_id_seq; Type: SEQUENCE; Schema: public; Owner: Gavin
--
...
ALTER TABLE meeting_id_seq OWNER TO "Gavin";

--
-- Name: meeting_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Gavin
--
...
--
-- Name: meeting_old; Type: TABLE; Schema: public; Owner: Gavin
--
...
ALTER TABLE meeting_old OWNER TO "Gavin";

--
-- Name: meeting_type; Type: TABLE; Schema: public; Owner: Gavin
--
...
ALTER TABLE meeting_type OWNER TO "Gavin";

--
-- Name: type; Type: TABLE; Schema: public; Owner: Gavin
--
...
ALTER TABLE type OWNER TO "Gavin";

--
-- Name: type_id_seq; Type: SEQUENCE; Schema: public; Owner: Gavin
--
...
ALTER TABLE type_id_seq OWNER TO "Gavin";

--
-- Name: type_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Gavin
--
...
--
-- Name: meeting id; Type: DEFAULT; Schema: public; Owner: Gavin
--
...
--
-- Name: type id; Type: DEFAULT; Schema: public; Owner: Gavin
--
...
COPY meeting (id, name, notes, updated, url, meetingtime, day, address, city, state, postal_code, country, latitude, longitude, region, timezone, location, location_notes) FROM stdin;
...
--
-- Name: meeting_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Gavin
--
...
--
-- Data for Name: meeting_old; Type: TABLE DATA; Schema: public; Owner: Gavin
--
...
--
-- Data for Name: meeting_type; Type: TABLE DATA; Schema: public; Owner: Gavin
--
...
--
-- Name: type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Gavin
--
...
--
-- Name: meeting meeting_pkey; Type: CONSTRAINT; Schema: public; Owner: Gavin
--
...
--
-- Name: meeting_type meeting_type_meetingid_typeid_pk; Type: CONSTRAINT; Schema: public; Owner: Gavin
--
...
--
-- Name: type type_pkey; Type: CONSTRAINT; Schema: public; Owner: Gavin
--
...
--
-- Name: meeting_id_uindex; Type: INDEX; Schema: public; Owner: Gavin
--
...
--
-- Name: type_id_uindex; Type: INDEX; Schema: public; Owner: Gavin
--
...
--
-- Name: meeting_type meeting_type_meeting_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: Gavin
--
...
--
-- Name: meeting_type meeting_type_type_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: Gavin
--
